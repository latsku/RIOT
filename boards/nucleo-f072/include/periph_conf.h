...
#define SPI_0_PIN_SCK       5                /* Be aware that green led and SPI_SCK share  */
#define SPI_0_PIN_MISO      6                /* the PA5 pin. SPI_SCK can't be moved as the */
#define SPI_0_PIN_MOSI      7                /* Arduino pin header expects it on D13.      */
